<script lang="ts">
  ...
  $effect(() => {
    ...
    return () => clearSpeechParagraph(viewport);
  });
</script>
...
<style>
  ...
  .rendered-markdown :global(strong){font-weight:700}.rendered-markdown :global(em){font-style:italic}.rendered-markdown :global(h1){font-size:1.8em}.rendered-markdown :global(h2){font-size:1.45em}.rendered-markdown :global(h3){font-size:1.2em}.rendered-markdown :global(ul){list-style:disc}.rendered-markdown :global(ol){list-style:decimal}.rendered-markdown :global(img){display:block;max-width:100%;height:auto;border-radius:8px;margin:12px 0}.rendered-markdown :global(audio){width:100%;margin:12px 0}.rendered-markdown :global(iframe){width:100%;aspect-ratio:16/9;border:0;border-radius:8px;margin:12px 0}.rendered-markdown :global(button[data-notes-media]),.rendered-markdown :global(.document-download){display:block;width:100%;padding:22px 16px;background:var(--wash);color:var(--accent);border:1px solid var(--line);border-radius:9px;text-align:left;margin:10px 0}.rendered-markdown :global(.document-download){box-sizing:border-box;text-decoration:none}.rendered-markdown :global(code){font-family:monospace;background:var(--wash);padding:2px 4px;border-radius:3px}.rendered-markdown :global(pre code){padding:0}.rendered-markdown :global(input){accent-color:var(--accent)}.rendered-markdown :global([data-notes-reading="true"]){background:color-mix(in srgb,var(--accent) 13%,transparent);box-shadow:0 0 0 5px color-mix(in srgb,var(--accent) 13%,transparent);border-radius:4px;transition:background-color .25s ease,box-shadow .25s ease}
