<script lang="ts">
  ...
  function openSpeechSettings(section: 'all'|'dictation'|'tts' = 'all') { stopReadAloud(); speechSettingsSection = section; speechSettingsOpen = true; }
...
.speech-actions{display:flex;align-items:center;flex-shrink:0;gap:2px}.speech-actions:empty{display:none}@container(max-width:680px){.speech-actions .icon{width:44px;height:44px}}
</style>
