...
- [ ] **Capture or continue** (first active slice): returning-user start,
...
- [ ] **Today and templates:** daily notes, meeting notes, project plans,
  groceries, and packing lists. Templates create fresh ordinary Markdown notes;
  users can save their own template without erasing earlier notes or history.
